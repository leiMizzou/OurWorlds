extends SceneTree
# 截一张发现遗迹 HUD 反馈：
#   VC_RADIUS=6 godot --path <项目> --script res://tests/shot_discovery.gd
...
func _initialize() -> void:
	...
	OS.set_environment("VC_SETTINGS_PATH", "user://tests/shot_discovery/settings.json")
...
func _process(_delta: float) -> bool:
	...
	if _f == 2:
		...
		if _landmark.y >= 0:
			...
			p.global_position = target + Vector3(-6.0, 3.2, -6.0)
		...
		img.save_png("res://_shot_discovery.png")
		print("SHOT saved: _shot_discovery.png")
		return true
	return false
